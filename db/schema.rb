...
ActiveRecord::Schema.define(:version => 20) do
  ...
  create_table "ap_signup", :id => false, :force => true do |t|
    t.column "ambassadorPledgeID", :integer, :limit => 10, :null => false
  ...
  create_table "cms_cmscategory", :id => false, :force => true do |t|
    t.column "CmsCategoryID", :integer, :limit => 10, :null => false
  ...
  create_table "cms_cmsfile", :id => false, :force => true do |t|
    t.column "CmsFileID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_answer", :id => false, :force => true do |t|
    t.column "answerID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_conference", :id => false, :force => true do |t|
    t.column "conferenceID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_customitem", :id => false, :force => true do |t|
    t.column "customItemID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_merchandise", :id => false, :force => true do |t|
    t.column "merchandiseID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_payment", :id => false, :force => true do |t|
    t.column "paymentID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_question", :id => false, :force => true do |t|
    t.column "questionID", :integer, :limit => 10, :null => false
    t.column "registrationType", :string, :limit => 50
    t.column "required", :string, :limit => 1
    t.column "displayOrder", :integer, :limit => 10
    t.column "fk_ConferenceID", :integer, :limit => 10
  ...
  create_table "crs_questiontext", :id => false, :force => true do |t|
    t.column "questionTextID", :integer, :limit => 10, :null => false
    t.column "body", :string, :limit => 7000
  ...
  create_table "crs_registration", :id => false, :force => true do |t|
    t.column "registrationID", :integer, :limit => 10, :null => false
  ...
  add_index "crs_registration", ["fk_ConferenceID", "fk_PersonID"], :name => "fk_PersonID"
  ...
  create_table "crs_registrationtype", :id => false, :force => true do |t|
    t.column "registrationTypeID", :integer, :limit => 10, :null => false
  ...
  create_table "crs_report", :id => false, :force => true do |t|
    t.column "reportID", :integer, :limit => 10, :null => false
  ...
  create_table "fsk_allocations", :force => true do |t|
    t.column "ssm_id", :integer, :limit => 10
    t.column "region_id", :integer, :limit => 10
    t.column "impact_allotment", :integer, :limit => 10
    t.column "forerunner_allotment", :integer, :limit => 10
    t.column "regional_allotment", :integer, :limit => 10
    t.column "regionally_raised", :integer, :limit => 10
    t.column "locally_raised", :integer, :limit => 10
    t.column "allocation_year", :string, :limit => 10
    t.column "national_notes", :text
    t.column "impact_notes", :text
    t.column "forerunner_notes", :text
    t.column "regional_notes", :text
    t.column "local_notes", :text
    t.column "lock_version", :integer, :limit => 10, :default => 0, :null => false
  ...
  create_table "fsk_fields_roles", :id => false, :force => true do |t|
    ...
    t.column "field_id", :integer, :limit => 10, :default => 0, :null => false
  end

  add_index "fsk_fields_roles", ["field_id"], :name => "FK_fsk_fields_roles_fsk_fields"
  ...
  create_table "fsk_orders", :force => true do |t|
    ...
    t.column "updated_at", :datetime
    t.column "allocation_id", :integer, :limit => 10
    ...
    t.column "ship_first_name", :string, :limit => 30
    t.column "ship_address1", :string, :limit => 50
    t.column "ship_address2", :string, :limit => 50
    t.column "ship_city", :string, :limit => 30
    t.column "ship_state", :string, :limit => 6
    t.column "ship_zip", :string, :limit => 10
    t.column "ship_phone", :string, :limit => 24
    t.column "total_kits", :integer, :limit => 10
    ...
    t.column "lock_version", :integer, :limit => 10, :default => 0, :null => false
    t.column "created_at", :datetime
    t.column "ship_last_name", :string
    t.column "freeze_order", :boolean, :default => false
  end
  ...
  create_table "fsk_products", :force => true do |t|
    ...
    t.column "created_at", :datetime
    t.column "updated_at", :datetime
    t.column "kit_category_id", :integer, :limit => 10
  ...
  create_table "hr_review360_review360", :id => false, :force => true do |t|
    t.column "Review360ID", :integer, :limit => 10, :null => false
  ...
  create_table "hr_review360_review360light", :id => false, :force => true do |t|
    t.column "Review360LightID", :integer, :limit => 10, :null => false
    t.column "reviewedByID", :string, :limit => 64
    t.column "reviewedByTitle", :string, :limit => 5
    t.column "reviewedByFirstName", :string, :limit => 30
    t.column "reviewedByLastName", :string, :limit => 30
  ...
  create_table "hr_review360_reviewsession", :id => false, :force => true do |t|
    t.column "ReviewSessionID", :integer, :limit => 10, :null => false
  ...
  create_table "hr_review360_reviewsessionlight", :id => false, :force => true do |t|
    t.column "ReviewSessionLightID", :integer, :limit => 10, :null => false
    t.column "name", :string, :limit => 80
    t.column "purpose", :string
    t.column "dateDue", :datetime
    t.column "dateStarted", :datetime
  ...
  create_table "hr_si_application_2003", :id => false, :force => true do |t|
    t.column "applicationID", :integer, :limit => 10, :null => false
    t.column "locationA", :integer
    t.column "locationAExplanation", :string, :limit => 90
    t.column "locationB", :integer
    t.column "locationBExplanation", :string, :limit => 90
    t.column "locationC", :integer
  ...
  add_index "hr_si_application_2003", ["fk_ssmUserID"], :name => "fk_ssmUserID"
  ...
  add_index "hr_si_application_2004", ["fk_PersonID"], :name => "fk_SIPersonID"
  add_index "hr_si_application_2004", ["fk_ssmUserID"], :name => "fk_ssmUserID"
  ...
  add_index "hr_si_application_2005", ["fk_PersonID"], :name => "fk_SIPersonID"
  add_index "hr_si_application_2005", ["fk_ssmUserID"], :name => "fk_ssmUserID"
  ...
  create_table "hr_si_application_2006", :id => false, :force => true do |t|
    ...
    t.column "appStatus", :string, :limit => 15
    t.column "assignedToProject", :integer, :limit => 10
    t.column "finalProject", :integer, :limit => 10
    t.column "siYear", :string, :limit => 50
    t.column "submitDate", :datetime
    t.column "status", :string, :limit => 22
    t.column "appType", :string, :limit => 64
  ...
  create_table "hr_si_applications", :id => false, :force => true do |t|
    t.column "applicationID", :integer, :limit => 10, :null => false
    t.column "oldApplicationID", :integer, :limit => 10
    t.column "locationA", :integer
    t.column "locationAExplanation", :string, :limit => 90
    t.column "locationB", :integer
    t.column "locationBExplanation", :string, :limit => 90
  ...
  create_table "hr_si_project", :id => false, :force => true do |t|
    t.column "SIProjectID", :integer, :limit => 10, :null => false
    t.column "name", :string
    ...
    t.column "fk_isCoord", :integer
    t.column "fk_isAPD", :integer
    t.column "fk_isPD", :integer
    ...
    t.column "lastChangedBy", :integer
  ...
  create_table "hr_si_reference", :id => false, :force => true do |t|
    t.column "referenceID", :integer, :limit => 10, :null => false
    t.column "oldReferenceID", :integer, :default => 0, :null => false
    ...
    t.column "_re5", :text
    t.column "oldSIApplicationID", :integer
    t.column "fk_SIApplicationID", :integer, :limit => 10
    t.column "siYear", :string, :limit => 4
  end
  ...
  create_table "hr_si_reference_2003", :id => false, :force => true do |t|
    ...
    t.column "_re4", :integer, :limit => 10
    t.column "_re5", :text
    t.column "fk_SIApplicationID", :integer
  end

  add_index "hr_si_reference_2003", ["fk_SIApplicationID"], :name => "fk_SIApplicationID"
  ...
  add_index "hr_si_reference_2004", ["fk_SIApplicationID"], :name => "fk_SIApplicationID"
  ...
  add_index "hr_si_reference_2005", ["fk_SIApplicationID"], :name => "fk_SIApplicationID"
  ...
  create_table "hr_si_users", :id => false, :force => true do |t|
    t.column "siUserID", :integer, :limit => 10, :null => false
    t.column "fk_ssmUserID", :integer, :limit => 10
  ...
  create_table "linczone_contacts", :id => false, :force => true do |t|
    t.column "ContactID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_activity", :id => false, :force => true do |t|
    t.column "ActivityID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_address", :id => false, :force => true do |t|
    t.column "AddressID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_authorization", :id => false, :force => true do |t|
    t.column "AuthorizationID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_changerequest", :id => false, :force => true do |t|
    t.column "ChangeRequestID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_dependent", :id => false, :force => true do |t|
    t.column "DependentID", :integer, :limit => 10, :null => false
    t.column "firstName", :string, :limit => 80
  ...
  create_table "ministry_fieldchange", :id => false, :force => true do |t|
    t.column "FieldChangeID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_newaddress", :id => false, :force => true do |t|
    t.column "AddressID", :integer, :limit => 10, :null => false
    t.column "deprecated_startDate", :string, :limit => 25
    t.column "deprecated_endDate", :string, :limit => 25
    ...
    t.column "email2", :string, :limit => 200
  end
  ...
  create_table "ministry_noncccmin", :id => false, :force => true do |t|
    t.column "NonCccMinID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_note", :id => false, :force => true do |t|
    t.column "NoteID", :integer, :limit => 10, :null => false
  ...
  create_table "ministry_person", :id => false, :force => true do |t|
    t.column "personID", :integer, :limit => 10, :null => false
    ...
    t.column "gender", :string, :limit => 1
    t.column "deprecated_birthDate", :string, :limit => 25
    t.column "deprecated_dateBecameChristian", :string, :limit => 35
    ...
    t.column "deprecated_graduationDate", :string, :limit => 25
    ...
    t.column "date_became_christian", :datetime
    t.column "graduation_date", :datetime
  end
  ...
  create_table "ministry_regionalstat", :id => false, :force => true do |t|
    t.column "RegionalStatID", :integer, :limit => 10, :null => false
    t.column "periodBegin", :datetime
    t.column "periodEnd", :datetime
  ...
  create_table "ministry_statistic", :id => false, :force => true do |t|
    t.column "StatisticID", :integer, :limit => 10, :null => false
    t.column "periodBegin", :datetime
    t.column "periodEnd", :datetime
    ...
    t.column "multipliers", :integer
    t.column "laborersSent", :integer
  end
  ...
  create_table "ministry_targetarea", :id => false, :force => true do |t|
    t.column "TargetAreaID", :integer, :limit => 10, :null => false
    t.column "name", :string, :limit => 100
    t.column "address1", :string, :limit => 35
    t.column "address2", :string, :limit => 35
    t.column "city", :string, :limit => 30
  ...
  create_table "oncampus_orders", :force => true do |t|
    ...
    t.column "purpose", :string, :limit => 100, :default => "", :null => false
    t.column "payment", :string, :limit => 100, :default => "", :null => false
    t.column "format_dvd", :boolean, :default => true, :null => false
    t.column "format_quicktime", :boolean, :default => false, :null => false
    t.column "format_flash", :boolean, :default => false, :null => false
    t.column "campus", :string, :limit => 100, :default => "", :null => false
    t.column "campus_state", :string, :limit => 50, :default => "", :null => false
    t.column "commercial_movement_name", :string, :limit => 200, :default => "", :null => false
    t.column "commercial_school_name", :string, :limit => 200
    t.column "commercial_additional_info", :text
    t.column "user_agreement", :boolean, :default => false, :null => false
    t.column "status", :string, :limit => 20, :default => "submitted", :null => false
    t.column "created_at", :datetime, :null => false
    t.column "commercial_website", :string, :limit => 300
    t.column "commercial_logo", :boolean, :default => true
    t.column "color", :string, :limit => 20, :default => "#FFFFFF"
    t.column "produced_at", :datetime
  ...
  create_table "oncampus_uses", :force => true do |t|
    ...
    t.column "context", :string, :limit => 20, :default => "", :null => false
    t.column "title", :string, :limit => 150, :default => "", :null => false
    t.column "date_start", :datetime
    t.column "date_end", :datetime
    t.column "single_event", :boolean, :default => false, :null => false
    t.column "commercial_frisbee", :boolean, :default => false, :null => false
    t.column "commercial_ramen", :boolean, :default => false, :null => false
    t.column "description", :text, :default => "", :null => false
    t.column "feedback", :text, :default => "", :null => false
  end
  ...
  add_index "simplesecuritymanager_user", ["globallyUniqueID"], :name => "globallyUniqueID"
  ...
  create_table "sitrack_columns", :force => true do |t|
    ...
    t.column "column_type", :string, :limit => 20, :default => "", :null => false
    t.column "select_clause", :string, :limit => 7000, :default => "", :null => false
    t.column "where_clause", :string
    t.column "update_clause", :string
    t.column "table_clause", :string, :limit => 100
    t.column "show_in_directory", :integer, :limit => 3, :default => 1, :null => false
  ...
  create_table "sitrack_enum_values", :force => true do |t|
    t.column "sitrack_column_id", :integer, :limit => 10, :default => 0, :null => false
  ...
  create_table "sitrack_forms", :force => true do |t|
    t.column "approver_id", :integer, :limit => 10, :default => 0, :null => false
    t.column "type", :string, :limit => 50, :default => "", :null => false
    t.column "current_years_salary", :integer
    t.column "previous_years_salary", :integer
    t.column "additional_salary", :integer
    t.column "adoption", :integer
    t.column "counseling", :integer
    t.column "childrens_expenses", :integer
    t.column "college", :integer
    t.column "private_school", :integer
    t.column "graduate_studies", :integer
    t.column "auto_purchase", :integer
    t.column "settling_in_expenses", :integer
    t.column "reimbursable_expenses", :integer
    t.column "tax_rate", :integer
    t.column "date_of_change", :datetime
    t.column "action", :string
    t.column "reopen_as", :string, :limit => 50
    t.column "freeze_start", :datetime
    t.column "freeze_end", :datetime
    t.column "change_assignment_from_team", :string, :limit => 50
    t.column "change_assignment_from_location", :string, :limit => 50
    t.column "change_assignment_to_team", :string, :limit => 50
    t.column "change_assignment_to_location", :string, :limit => 50
    t.column "restint_location", :string, :limit => 50
    t.column "departure_date_certainty", :string, :limit => 20
    t.column "hours_per_week", :integer
    t.column "other_explanation", :string
    t.column "new_staff_training_date", :datetime
    t.column "payroll_action", :string, :limit => 50
    t.column "payroll_reason", :string, :limit => 50
    t.column "hrd", :string, :limit => 100
    t.column "spouse_name", :string, :limit => 100
    t.column "spouse_transitioning", :boolean
    t.column "salary_reason", :string
    t.column "annual_salary", :integer
    t.column "hr_si_application_id", :integer, :default => 0, :null => false
  end

  create_table "sitrack_mpd", :force => true do |t|
    t.column "application_id", :integer, :limit => 10
    t.column "person_id", :integer, :limit => 10
  ...
  create_table "sitrack_queries", :force => true do |t|
    ...
    t.column "created_at", :datetime
    t.column "updated_at", :binary, :limit => 8
  end
  ...
  create_table "sitrack_sessions", :force => true do |t|
    t.column "sitrack_user_id", :integer, :limit => 10, :default => 0, :null => false
    t.column "created_at", :datetime, :null => false
  end
  ...
  create_table "sitrack_tracking", :force => true do |t|
    ...
    t.column "ikw_location", :string, :limit => 100
    t.column "summer_preference", :string, :limit => 100
    t.column "summer_assignment", :string, :limit => 100
  end
  ...
  create_table "sitrack_users", :force => true do |t|
    ...
    t.column "created_at", :datetime
    t.column "created_by", :integer, :limit => 10
    t.column "updated_at", :datetime
    t.column "updated_by", :integer, :limit => 10
    t.column "ssm_id", :integer
  end

  create_table "sitrack_view_columns", :force => true do |t|
    t.column "sitrack_view_id", :integer, :limit => 10, :default => 0, :null => false
    t.column "sitrack_column_id", :integer, :limit => 10, :default => 0, :null => false
    t.column "position", :integer, :limit => 10, :default => 0, :null => false
  end

  create_table "sitrack_views", :force => true do |t|
    t.column "sitrack_user_id", :integer, :limit => 10
    t.column "name", :string
  end

  add_index "sitrack_views", ["sitrack_user_id"], :name => "uuid"

  create_table "sp_ministry_focus", :force => true do |t|
    t.column "name", :string
  end

  create_table "staffsite_staffsitepref", :id => false, :force => true do |t|
    t.column "StaffSitePrefID", :integer, :limit => 10, :null => false
    t.column "name", :string, :limit => 64
  ...
  add_index "wsn_sp_answer", ["fk_QuestionID", "fk_WsnApplicationID"], :name => "fk_WsnApplicationID"
  ...
  add_index "wsn_sp_question", ["fk_WsnProjectID"], :name => "fk_WsnProjectID"
  add_index "wsn_sp_question", ["fk_QuestionTextID"], :name => "fk_QuestionTextID"
  ...
  add_index "wsn_sp_reference", ["fk_WsnApplicationID"], :name => "fk_WsnApplicationID"


  create_table "wsn_sp_wsnapplication", :id => false, :force => true do |t|
    t.column "WsnApplicationID", :integer, :limit => 10, :null => false
    ...
    t.column "projectPref1", :integer
    t.column "projectPref2", :integer
    t.column "projectPref3", :integer
    t.column "projectPref4", :integer
    t.column "projectPref5", :integer
  ...
  add_index "wsn_sp_wsnapplication", ["fk_personID"], :name => "fk_personID"

  create_table "wsn_sp_wsndonations", :id => false, :force => true do |t|
    t.column "WsnDonationsID", :integer, :limit => 10, :null => false
    t.column "accountno", :string, :limit => 11
    t.column "monetary_amount", :float, :default => 0.0, :null => false
  end

  add_index "wsn_sp_wsndonations", ["accountno"], :name => "accountno"

  create_table "wsn_sp_wsnevaluation", :id => false, :force => true do |t|
    t.column "evalID", :integer, :limit => 10, :null => false
  ...
  create_table "wsn_sp_wsnproject", :id => false, :force => true do |t|
    t.column "WsnProjectID", :integer, :limit => 10, :null => false
    t.column "name", :string
    t.column "partnershipRegion", :string, :limit => 50
    t.column "history", :text
    ...
    t.column "statesideContactName", :string, :limit => 45
    t.column "statesideContactProjectRole", :string, :limit => 35
    t.column "statesideContactPhone", :string, :limit => 20
    t.column "statesideContactEmail", :string, :limit => 75
    t.column "currentNoStudentAMale", :integer
    t.column "currentNoStudentPMale", :integer
    t.column "currentNoStudentAFemale", :integer
    t.column "currentNoStudentPFemale", :integer
    t.column "numApplicants", :integer
  end
  ...
  create_table "wsn_sp_wsnusers", :id => false, :force => true do |t|
    t.column "wsnUserID", :integer, :limit => 10, :null => false
