class SitrackSalaryForm < SitrackForm
  def validate
    ...
    errors.add_on_empty('Birth Date') if hr_si_application.person.birthDate.nil? || hr_si_application.person.birthDate.to_s.empty?
    errors.add_on_empty('Hire Date (Effective Date of Change)') if date_of_change.nil? || date_of_change.to_s.empty?
    errors.add_on_empty('City') if hr_si_application.sitrack_tracking.asgCity.nil? || hr_si_application.sitrack_tracking.asgCity.empty?
